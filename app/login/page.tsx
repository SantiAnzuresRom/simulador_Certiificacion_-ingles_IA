...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#f8fafc] px-6 overflow-hidden font-sans">
      {/* Background Decor - Efectos de profundidad */}
      ...
      >
        ...
        <div className="hidden md:flex flex-col items-center justify-between bg-[#0f172a] p-16 text-white relative">
          ...
          <div className="relative z-10 text-center w-full">
            ...
            <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.4em] italic leading-relaxed">
            <br/> <span className="text-sky-400/60">Tu mejor aliado para triunfar</span>
            </p>
          </div>
          ...
          <div className="relative z-10 w-full">
            <div className="flex items-center gap-4 mb-8 justify-center">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.5em] text-sky-400">Social_Network</span>
              <div className="h-[1px] w-10 bg-white/10" />
            </div>
            
            <div className="flex justify-center gap-6">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center gap-2">
                <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center transition-all group-hover:bg-[#1877F2] group-hover:border-[#1877F2] group-hover:scale-110">
                  <Facebook size={22} className="text-slate-400 group-hover:text-white" />
                </div>
              </a>
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center gap-2">
                <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center transition-all group-hover:bg-white group-hover:border-white group-hover:scale-110">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-slate-400 group-hover:text-black">
        ...
        <div className="p-12 md:p-16 flex flex-col justify-center bg-white">
          <header className="mb-10 text-center md:text-left">
            <div className="flex items-center gap-2 mb-2 justify-center md:justify-start">
              <span className="text-[10px] font-black text-sky-500 uppercase tracking-[0.4em]">Secure_Access</span>
              <div className="h-[1px] w-6 bg-sky-200" />
            </div>
            <h1 className="text-3xl font-black text-slate-900 tracking-tight italic uppercase">Bienvenido</h1>
          </header>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full rounded-2xl bg-[#0f172a] py-4 text-[11px] font-black text-white uppercase tracking-[0.2em] transition-all mt-6 hover:bg-sky-500 hover:text-white flex justify-center items-center shadow-lg active:scale-[0.98] disabled:opacity-50 group overflow-hidden"
            >
              {isLoading ? <Loader2 className="animate-spin" size={20} /> : (
                <span className="flex items-center gap-3">
                  Entrar al Sistema <SendIcon className="w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                </span>
              )}
            </button>
          </form>
          ...
          <div className="my-8 flex items-center gap-4">
            ...
            <span className="text-[9px] font-black text-slate-300 uppercase tracking-widest">O entrar con</span>
            <div className="h-[1px] flex-1 bg-slate-100" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button 
              ...
              className="flex items-center justify-center gap-3 py-3.5 border border-slate-200 rounded-2xl hover:bg-slate-50 transition-all text-[10px] font-black text-slate-700 uppercase"
            >
          ...
          <Link 
            ...
            className="text-center mt-10 text-[10px] text-slate-400 hover:text-sky-500 transition-colors font-black uppercase tracking-widest"
          >
            ¿Olvidaste tu acceso?
          </Link>
        </div>
...
// Icono decorativo de flecha/envío
